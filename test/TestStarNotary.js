...
it('can add the star name and star symbol properly', async () => {
    ...
    // NOTE: I'm not sure why this is necessary for this test case.
    // let tokenId = 100;
    // await instance.createStar('Awesome Star Name And Symbol!', tokenId, { from: accounts[0] })
...
it('lookUptokenIdToStarInfo test', async () => {
    ...
    let starName = "Super Large Token Number";

    await instance.createStar(starName, tokenId, { from: owner });
    let createdStarName = await instance.lookUptokenIdToStarInfo(tokenId);
